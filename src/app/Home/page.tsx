...
export default function Home() {
  ...
  const recentNews: NewsProps[] = [
    { id: "1", title: "Título 1", date: "20/08/2024", poster: ExampleNoticie },
    { id: "2", title: "Título 2", date: "20/08/2024", poster: ExampleNoticie },
    { id: "3", title: "Título 3", date: "20/08/2024", poster: ExampleNoticie },
  ];

  const handlerAccessNewsDetails = (id: string) => {
    router.push(`/News/DetailsNews/${id}`);
  }
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Welcome Section */}
      <TitlePage
        title="Descubra Nossa Cultura: Acompanhe Notícias e Eventos"
        subtitle=""
